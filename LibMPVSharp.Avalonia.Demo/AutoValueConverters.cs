...
namespace LibMPVSharp.Avalonia.Demo
{
    public class AutoValueConverters : IValueConverter
    {
        ...
        public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            {
                return TimeSpanConverter(ts, parameter as string);
            }
            ...
            {
                return DoubleToString(doubleVal, parameter as string);
            }
            return "";
        }
        ...
        public object? ConvertBack(object? value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            {
                return DoubleConverter(val, parameter as string);
            }
            ...
            {
                return StringToDouble(strVal, parameter as string);
            }
            return "";
        }
